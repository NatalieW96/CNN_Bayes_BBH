...
def main(args):
    ...
    print('Results will be saved at: {0}/run{1}'.format(args.outdir,Nrun))
    ...
    #shutil.copy('./runCNN.sh', '{0}/run{1}'.format(args.outdir,Nrun))
    ...
    np.save('{0}/run{1}/test_results.pny'.format(args.outdir,Nrun),eval_results)
